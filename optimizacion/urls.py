...
urlpatterns = [
    ...
    path('producto/mezcla', views.producto.MezclaProducto.productoReformador,name='Mezcla de productos intermedios al reformador'),
    path('producto/modelo', views.producto.MezclaProducto.detallesResultantes,name='Resultados del modelo'),
    ...
    path('producto_especificacion', views.producto_final.ProductoEspecificacionList.as_view(),name='Lista de productos finales'),
    path('producto_especificacion/<int:pk>', views.producto_final.ProductoEspecificacionDetail.as_view(),name='Crud de los productos finales'),
